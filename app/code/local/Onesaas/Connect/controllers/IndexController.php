...
class Onesaas_Connect_IndexController extends Mage_Core_Controller_Front_Action{
	...
	private function getOrderInfo($id,$original_id, $LUD){
		...
		$shippings_array = array(
			...
			'Tax'=>array(
			'TaxName'=>"",
			'TaxRate'=>htmlspecialchars($order->getData('base_shipping_tax_amount')/$order->getBaseShippingAmount()),
		...
		*/
		...
		// OS-3835
		$customFields_array = array('CustomField Name="CreditPoints"'=>$order->getData('creditpoint_amount'),'CustomField Name="OrderProcessingFee"'=>$order->getData('et_payment_extra_charge_excluding_tax'));
		$ord_info = array(
