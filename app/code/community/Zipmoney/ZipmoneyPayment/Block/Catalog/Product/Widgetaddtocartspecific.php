...
class Zipmoney_ZipmoneyPayment_Block_Catalog_Product_Widgetaddtocartspecific extends Zipmoney_ZipmoneyPayment_Block_Catalog_Product_Abstract
{
        ...
        if ($this->_isZipMoneyPaymentActive()) {
            if ($this->_isShowExpressButton($this->_design, $this->_position)) {
                if ($this->_isAllowedToCheckout()) {
                    ...
                    $this->setTemplate('zipmoney/zipmoneypayment/widget/productaddtocartgeneral.phtml');
                }
