...
class Zipmoney_ZipmoneyPayment_Block_Checkout_Cart_Widgetspecificbelow extends Zipmoney_ZipmoneyPayment_Block_Checkout_Cart_Abstract {
        ...
        if ($this->_isZipMoneyPaymentActive()) {
            if ($this->_isShowExpressButton($this->_design, $this->_position)) {
                if ($this->_isAllowedToCheckout()) {
                    ...
                    $this->setTemplate('zipmoney/zipmoneypayment/widget/cartgeneral_below.phtml');
                }
